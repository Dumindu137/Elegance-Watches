 ...
 * @author Dumindu
 */
@WebServlet(name = "LoadProductPageData", urlPatterns = {"/LoadProductPageData"})
public class LoadProductPageData extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Status status = (Status)s.get(Status.class, LoadProductPageData.ACTIVE_STATUS_ID);
